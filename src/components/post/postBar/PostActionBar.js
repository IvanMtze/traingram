    ...
    return (
        <div className="options__bar">
            <div className="div__likes">
                ...
                />
                <div className="div__likes__count">
                    <h5 className="likes__count">{likesUser.likes.length}</h5>
                </div>
            </div>
            <div>
                <svg className="div__svg__comment" viewBox="0 0 48 48" preserveAspectRatio="none">
                    <path clipRule="evenodd" d="M47.5 46.1l-2.8-11c1.8-3.3 2.8-7.1 2.8-11.1C47.5 11 37 .5 24 .5S.5 11 .5 24 11 47.5 24 47.5c4 0 7.8-1 11.1-2.8l11 2.8c.8.2 1.6-.6 1.4-1.4zm-3-22.1c0 4-1 7-2.6 10-.2.4-.3.9-.2 1.4l2.1 8.4-8.3-2.1c-.5-.1-1-.1-1.4.2-1.8 1-5.2 2.6-10 2.6-11.4 0-20.6-9.2-20.6-20.5S12.7 3.5 24 3.5 44.5 12.7 44.5 24z" fillRule="evenodd" transform="scale(0.8,0.8)"></path>
                </svg>
            </div>
